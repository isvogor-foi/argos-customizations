/**
 * @file <argos3/plugins/robots/e-pucky/simulator/epucky_entity.cpp>
 *
...
namespace argos {
   ...
   CEPuckyEntity::CEPuckyEntity(const std::string& str_id,
   ...
   void CEPuckyEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CEPuckyEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CEPuckyEntity,
                   "e-pucky",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The e-pucky robot.",
                   "The e-pucky is a open-hardware, extensible robot intended for education. In its\n"
                   ...
                   "red LEDs. More information is available at http://www.epucky.org\n\n"
                   ...
                   "The 'body/position' attribute specifies the position of the puckytom point of the\n"
                   "e-pucky in the arena. When the robot is untranslated and unrotated, the\n"
                   "puckytom point is in the origin and it is defined as the middle point between\n"
                   ...
                   "The 'body/orientation' attribute specifies the orientation of the e-pucky. All\n"
                   "rotations are performed with respect to the puckytom point. The order of the\n"
                   ...
                   "e-pucky. The value of the attribute must be set to the id of a previously\n"
                   "defined controller. Controllers are defined in the <controllers> XML subtree.\n\n"
                   "OPTIONAL XML CONFIGURATION\n\n"
                   "You can set the emission range of the range-and-bearing system. By default, a\n"
                   "message sent by an e-pucky can be received up to 80cm. By using the 'rab_range'\n"
                   "attribute, you can change it to, i.e., 4m as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <e-pucky id=\"eb0\" rab_range=\"4\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,90,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </e-pucky>\n"
                   "    ...\n"
                   ...
                   "system. By default, a message sent by an e-pucky is 2 bytes long. By using the"
                   "'rab_data_size' attribute, you can change it to, i.e., 20 bytes as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <e-pucky id=\"eb0\" rab_data_size=\"20\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,90,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </e-pucky>\n"
                   "    ...\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CEPuckyEntity);
