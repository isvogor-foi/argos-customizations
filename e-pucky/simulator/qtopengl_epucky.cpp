/**
 * @file <argos3/plugins/robots/e-pucky/simulator/qtopengl_epucky.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_epucky.h"
...
namespace argos {
   ...
   CQTOpenGLEPucky::CQTOpenGLEPucky() :
      m_unVertices(40),
   ...
   void CQTOpenGLEPucky::Draw(CEPuckyEntity& c_entity) {
      /* Place the chassis */
   ...
   void CQTOpenGLEPucky::SetGreenPlasticMaterial() {
      const GLfloat pfColor[]     = {   0.0f, 0.0f, 0.7f, 1.0f };
   ...
   void CQTOpenGLEPucky::SetRedPlasticMaterial() {
   ...
   void CQTOpenGLEPucky::SetCircuitBoardMaterial() {
   ...
   void CQTOpenGLEPucky::SetLEDMaterial(GLfloat f_red,
                                       GLfloat f_green,
                                       GLfloat f_blue) {
   ...
   void CQTOpenGLEPucky::RenderWheel() {
      /* Set material */
   ...
   void CQTOpenGLEPucky::RenderChassis() {
      /* Set material */
   ...
   void CQTOpenGLEPucky::RenderBody() {
      /* Set material */
      SetGreenPlasticMaterial();
   ...
   void CQTOpenGLEPucky::RenderLED() {
      /* Side surface */
      CVector2 cVertex(BODY_RADIUS, 0.0f);
      CRadians cAngle(CRadians::TWO_PI / m_unVertices);
      CVector2 cNormal(1.0f, 0.0f);
   ...
   class CQTOpenGLOperationDrawEPuckyNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CEPuckyEntity& c_entity) {
         static CQTOpenGLEPucky m_cModel;
   ...
   class CQTOpenGLOperationDrawEPuckySelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CEPuckyEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawEPuckyNormal, CEPuckyEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawEPuckySelected, CEPuckyEntity);
