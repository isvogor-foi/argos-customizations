/**
 * @file <argos3/plugins/robots/e-puck/simulator/base_station_entity.cpp>
 *
...
namespace argos {
   ...
   CEBaseStationEntity::CEBaseStationEntity() :
   ...
   CEBaseStationEntity::CEBaseStationEntity(const std::string& str_id,
   ...
   void CEBaseStationEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
   ...
   void CEBaseStationEntity::Reset() {
   ...
   void CEBaseStationEntity::Destroy() {
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CEBaseStationEntity::UpdateComponents() {
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CEBaseStationEntity);
