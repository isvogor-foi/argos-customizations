/**
 * @file <argos3/plugins/ropucks/e-puck/simulator/physx_base_station_model.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "physx_base_station_model.h"
...
namespace argos {
   ...
   CPhysXEBaseStationModel::CPhysXEBaseStationModel(CPhysXEngine& c_engine,
      ...
      RegisterAnchorMethod(GetEmbodiedEntity().GetOriginAnchor(),
                           &CPhysXEBaseStationModel::UpdateOriginAnchor);
   }

   /****************************************/
   /****************************************/

   void CPhysXEBaseStationModel::Reset() {
      /* Reset bodies */
   ...
   void CPhysXEBaseStationModel::UpdateFromEntityStatus() {
      /* Do we want to move? */
   ...
   void CPhysXEBaseStationModel::UpdateOriginAnchor(SAnchor& s_anchor) {
   ...
   REGISTER_STANDARD_PHYSX_OPERATIONS_ON_ENTITY(CEBaseStationEntity, CPhysXEBaseStationModel);
