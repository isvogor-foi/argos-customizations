/**
 * @file <argos3/plugins/robots/foot-bot/simulator/efootbot_motor_ground_rotzonly_sensor.cpp>
 *
...
#include "efootbot_motor_ground_rotzonly_sensor.h"
...
namespace argos {
   ...
   CEFootBotMotorGroundRotZOnlySensor::CEFootBotMotorGroundRotZOnlySensor() :
   ...
   void CEFootBotMotorGroundRotZOnlySensor::SetRobot(CComposableEntity& c_entity) {
   ...
   void CEFootBotMotorGroundRotZOnlySensor::Init(TConfigurationNode& t_tree) {
      try {
         CCI_EFootBotMotorGroundSensor::Init(t_tree);
         /* Parse noise level */
   ...
   void CEFootBotMotorGroundRotZOnlySensor::Update() {
      /*
   ...
   void CEFootBotMotorGroundRotZOnlySensor::Reset() {
   ...
   REGISTER_SENSOR(CEFootBotMotorGroundRotZOnlySensor,
                   "efootbot_motor_ground", "rot_z_only",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The foot-bot motor ground sensor.",
                   "This sensor accesses the foot-bot motor ground sensor. For a complete description\n"
                   "of its usage, refer to the ci_efootbot_motor_ground_sensor.h interface. For the XML\n"
