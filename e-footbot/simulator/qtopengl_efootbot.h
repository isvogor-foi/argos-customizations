/**
 * @file <argos3/plugins/robots/foot-bot/simulator/qtopengl_efootbot.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef QTOPENGL_EFOOTBOT_H
#define QTOPENGL_EFOOTBOT_H

namespace argos {
   class CQTOpenGLEFootBot;
