/**
 * @file <argos3/plugins/robots/foot-bot/simulator/efootbot_entity.cpp>
 *
...
namespace argos {
   ...
   CEFootBotEntity::CEFootBotEntity() :
   ...
   CEFootBotEntity::CEFootBotEntity(const std::string& str_id,
      ...
      try {
        ...
        AddComponent(*m_pcBatterySensorEquippedEntity);
         ...
         m_pcDistanceScannerEquippedEntity =
            new CEFootBotDistanceScannerEquippedEntity(this, "distance_scanner_0");
         ...
         m_pcTurretEntity = new CEFootBotTurretEntity(this, "turret_0", cTurretAnchor);
   ...
   void CEFootBotEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CEFootBotEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CEFootBotEntity,
                   "e-footbot",
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CEFootBotEntity);
