/**
 * @file <argos3/plugins/robots/foot-bot/simulator/efootbot_turret_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef EFOOTBOT_TURRET_ENTITY_H
#define EFOOTBOT_TURRET_ENTITY_H
...
namespace argos {
   ...
   class CEFootBotTurretEntity : public CEntity {
   ...
   public:
      ...
      CEFootBotTurretEntity(CComposableEntity* pc_parent);
