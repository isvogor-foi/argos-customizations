/**
 * @file <argos3/plugins/robots/foot-bot/simulator/efootbot_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef EFOOTBOT_ENTITY_H
#define EFOOTBOT_ENTITY_H

namespace argos {
   class CControllableEntity;
   class CEFootBotDistanceScannerEquippedEntity;
   class CEmbodiedEntity;
   class CEFootBotEntity;
   class CEFootBotTurretEntity;
...
namespace argos {
   ...
   class CEFootBotEntity : public CComposableEntity {
   ...
   public:
      ...
      CEFootBotEntity(const std::string& str_id,
      ...
      inline CEFootBotDistanceScannerEquippedEntity& GetDistanceScannerEquippedEntity() {
         return *m_pcDistanceScannerEquippedEntity;
      }

      inline CEFootBotTurretEntity& GetTurretEntity() {
