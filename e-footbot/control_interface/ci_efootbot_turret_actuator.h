/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_turret_actuator.h>
 *
...
#ifndef CCI_EFOOTBOT_TURRET_ACTUATOR_H
#define CCI_EFOOTBOT_TURRET_ACTUATOR_H

namespace argos {
   class CCI_EFootBotTurretActuator;
}
...
namespace argos {
   ...
   class CCI_EFootBotTurretActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Destructor.
       */
      virtual ~CCI_EFootBotTurretActuator() {}
       ...
       * @param un_mode turret control mode, possible values are defined in CCI_EFootBotTurretActuator
       */
