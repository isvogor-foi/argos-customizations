/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_distance_scanner_actuator.h>
 *
...
#ifndef CCI_EFOOTBOT_DISTANCE_SCANNER_ACTUATOR_H
#define CCI_EFOOTBOT_DISTANCE_SCANNER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_EFootBotDistanceScannerActuator;
};
...
namespace argos {
   ...
   class CCI_EFootBotDistanceScannerActuator: virtual public CCI_Actuator {
   ...
   public:
        ...
        * Destructor.
        */
      virtual ~CCI_EFootBotDistanceScannerActuator() {}
