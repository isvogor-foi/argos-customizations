...
/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_base_ground_sensor.cpp>
 *
 * @brief This file provides the implementation of the efootbot base ground sensor.
 *
...
#include "ci_efootbot_base_ground_sensor.h"
...
namespace argos {
   ...
   CCI_EFootBotBaseGroundSensor::CCI_EFootBotBaseGroundSensor() :
      m_tReadings(8) {
   ...
   const CCI_EFootBotBaseGroundSensor::TReadings& CCI_EFootBotBaseGroundSensor::GetReadings() const {
     return m_tReadings;
   }
...
#ifdef ARGOS_WITH_LUA
   void CCI_EFootBotBaseGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
