/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_encoder_sensor.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "ci_efootbot_encoder_sensor.h"
...
namespace argos {
  ...
  const CCI_EFootBotEncoderSensor::SReading& CCI_EFootBotEncoderSensor::GetReading() const {
    return m_sReading;
  }
...
#ifdef ARGOS_WITH_LUA
  void CCI_EFootBotEncoderSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
  void CCI_EFootBotEncoderSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
