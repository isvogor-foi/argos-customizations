/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_distance_scanner_sensor.h>
 *
...
#ifndef CCI_EFOOTBOT_DISTANCE_SCANNER_SENSOR_H
#define CCI_EFOOTBOT_DISTANCE_SCANNER_SENSOR_H
...
namespace argos {
   ...
   class CCI_EFootBotDistanceScannerSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Constructor
       */
      CCI_EFootBotDistanceScannerSensor() :
         m_tReadings(4){
      }
       ...
       * Destructor
       */
      virtual ~CCI_EFootBotDistanceScannerSensor() {}
