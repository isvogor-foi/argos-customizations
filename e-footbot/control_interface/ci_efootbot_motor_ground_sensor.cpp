...
/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_motor_ground_sensor.cpp>
 *
 * @author Carlo Pinciroli <ilpincy@gmail.com>
 */

#include "ci_efootbot_motor_ground_sensor.h"
...
namespace argos {
   ...
   CCI_EFootBotMotorGroundSensor::CCI_EFootBotMotorGroundSensor() :
      m_tReadings(4) {
   ...
   const CCI_EFootBotMotorGroundSensor::TReadings& CCI_EFootBotMotorGroundSensor::GetReadings() const {
     return m_tReadings;
   }
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_EFootBotMotorGroundSensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_EFootBotMotorGroundSensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_EFootBotMotorGroundSensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_EFootBotMotorGroundSensor::ReadingsToLuaState(lua_State* pt_lua_state) {
