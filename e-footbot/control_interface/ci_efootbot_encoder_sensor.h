 ...
 * On the efootbot there is a sensor that, at start-up, measure this distance,
...
#ifndef CCI_EFOOTBOT_ENCODER_SENSOR_H
#define CCI_EFOOTBOT_ENCODER_SENSOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_EFootBotEncoderSensor;
}
...
namespace argos {
   ...
   class CCI_EFootBotEncoderSensor : public CCI_Sensor {
   ...
   public:
       ...
       * Destructor
       */
      virtual ~CCI_EFootBotEncoderSensor() {}
