/**
 * @file <argos3/plugins/robots/foot-bot/control_interface/ci_efootbot_gripper_actuator.h>
 *
...
#ifndef CCI_EFOOTBOT_GRIPPER_ACTUATOR_H
#define CCI_EFOOTBOT_GRIPPER_ACTUATOR_H

/* To avoid dependency problems when including */
namespace argos {
   class CCI_EFootBotGripperActuator;
}
...
namespace argos {
   ...
   class CCI_EFootBotGripperActuator : virtual public CCI_Actuator {
   ...
   public:
       ...
       * Class constructor.
       */
      CCI_EFootBotGripperActuator();

      /**
       * Class destructor.
       */
      virtual ~CCI_EFootBotGripperActuator() {}
